...
st.markdown("This prior is a flat prior.")
...
if page==2:
   menu=menu = ["GW170817_info","GW170817_xxx"]
...
if page==3:
     ...
     menu=menu = ["GW170817_info and prior 1","GW170817_info and prior 2","GW170817_xxx and prior 1","GW170817_xxx and prior 2"]
     choice = st.selectbox("Menu",menu)
